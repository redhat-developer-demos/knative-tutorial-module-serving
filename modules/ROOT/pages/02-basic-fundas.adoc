...
ifdef::workshop[]
:service-file: service-env.remote.yaml
endif::[]
...
ifdef::workshop[]
:service-file: service-pinned.remote.yaml
endif::[]
...
cat {service-file} | yq w - "spec.release.revisions[+]" $PIN_REVISION | kubectl -n {tutorial-namespace} apply -f -
----
...
cat {service-file} | yq w - "spec.release.revisions[+]" $PIN_REVISION | oc -n {tutorial-namespace}  apply -f -
----
