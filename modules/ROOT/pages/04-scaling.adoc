...
After the deployment was successful of the service we should see a Kubernetes deployment like `greeter-v1-deployment`.
...
After the deployment was successful we should see a Kubernetes Deployment called `greeter-v2-deployment` with **two** pods available.
