...
ifdef::workshop[]
:service-file: service-10.remote.yaml
:greeter-image: quay.io/rhdevelopers/knative-tutorial-greeter:quarkus
endif::[]
...
ifdef::workshop[]
:service-file: service-min-scale.remote.yaml
:greeter-image: quay.io/rhdevelopers/prime-generator:v27-quarkus
endif::[]

ifndef::workshop[]
:service-file: service-min-scale
:greeter-image: quay.io/rhdevelopers/prime-generator:v27-quarkus
endif::[]
