...
[source,yaml,subs="attributes+,+macros"]
----
include::ROOT:example$eventing/channel-subscriber.yaml[]
----

Run the following commands to create the channel subscriber:

:doc-sec: create-subscriber
:url: {github-repo}/{eventing-repo}/channel-subscriber.yaml
...
.link:{github-repo}/{eventing-repo}/service.yaml[service.yaml]
[source,yaml,subs="attributes+,+macros"]
----
include::ROOT:example$eventing/service.yaml[]
----
...
:url: {github-repo}/{eventing-repo}/service.yaml
